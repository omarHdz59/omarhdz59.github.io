...
excerpt: "BoardLight es una máquina Linux de dificultad fácil que expone los riesgos asociados a la reutilización de credenciales y la falta de parches de seguridad. El vector de ataque combina el descubrimiento de subdominios con la explotación de una vulnerabilidad conocida (CVE-2024-27282 en Dolibarr ERP) para obtener la ejecución remota de comandos (RCE) y el acceso inicial; posteriormente, tras realizar un movimiento lateral mediante contraseñas reutilizadas, la escalada a root se consolida explotando un fallo de elevación de privilegios local (CVE-2022-37706 en Enlightenment), logrando el compromiso total del sistema."
date: 2026-03-05
classes: wide
header:
  teaser: /assets/images/BoardLight/logo.png
  teaser_home_page: true
  icon: /assets/images/hackthebox.webp
categories:
  - hackthebox
tags: ["CVE-2023-30253", "dolibarr-rce", "CVE-2022-37706", "escalada-de-privilegios-enlightenment"]
---

![images](/assets/images/BoardLight/logo.png)
...
- **Autor**: cY83rR0H1t
- **Técnicas usadas**: Enumeración de subdominios, Explotación RCE Dolibarr (CVE-2023-30253), Escalada de privilegios enlightenment (CVE-2022-37706).
...
![images](/assets/images/BoardLight/port-scan.png)
...
![images](/assets/images/BoardLight/services-version.png)
...
![images](/assets/images/BoardLight/web.png)
...
![images](/assets/images/BoardLight/dolibarr.png)
...
![images](/assets/images/BoardLight/default-pass.png)
...
![images](/assets/images/BoardLight/reverse-shell.png)
...
![images](/assets/images/BoardLight/larissa-access.png)
...
![images](/assets/images/BoardLight/user-flag.png)
...
![images](/assets/images/BoardLight/exploit-find.png)
...
![images](/assets/images/BoardLight/root-access.png)

**Comando:** `whoami && cat /root/root.txt`

![images](/assets/images/BoardLight/final-flag.png)
