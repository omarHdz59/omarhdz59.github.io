...
excerpt: "Antique es una máquina Linux de dificultad fácil que pone a prueba conceptos fundamentales de seguridad ofensiva. La intrusión comienza con una fase de enumeración del protocolo SNMP, lo que permite descubrir configuraciones inseguras en un servicio de impresión HP vulnerable a la ejecución remota de comandos (RCE); finalmente, el vector de escalada de privilegios requiere la explotación del CVE-2012-5519, un fallo que permite la lectura arbitraria de archivos críticos del sistema para comprometer la máquina por completo. "
date: 2026-03-05
classes: wide
header:
  teaser: /assets/images/antique/machine-logo.png
  teaser_home_page: true
  icon: /assets/images/hackthebox.webp
categories:
  - hackthebox
  - infosec
tags: ["escaneo-de-puertos-udp", "enumeracion-snmp", "snmpwalk", "explotacion-cups"]
---

![image](/assets/images/antique/machine-logo.png)
...
- **Autor**: MrR3boot
- **Técnicas usadas**: Enumeración SNMP, Explotación de CUPS administration y Port forwarding.
...
![image](/assets/images/antique/Telnet-login.png)
...
![image](/assets/images/antique/Exec-telnet.png)
