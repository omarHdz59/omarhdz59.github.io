...
excerpt: "Bashed es una máquina Linux de dificultad fácil enfocada en conceptos esenciales de enumeración web y escalada de privilegios. El vector de acceso inicial se logra al identificar un entorno de pruebas expuesto (la famosa consola phpbash) que permite la ejecución de comandos en el servidor; posteriormente, la fase de post-explotación requiere auditar el sistema para descubrir una tarea programada (cron job) que ejecuta el usuario root sobre un script donde nuestro usuario tiene permisos de escritura, logrando el compromiso total del sistema mediante la modificación de dicho archivo."
date: 2026-03-05
classes: wide
header:
  teaser: /assets/images/Bashed/logo.png
  teaser_home_page: true
  icon: /assets/images/hackthebox.webp
categories:
  - hackthebox
  - infosec
tags: ["explotacion-de-webshell", "pspy", "explotacion-de-tareas-cron", "python-script-hijacking"]
---

# Información
---

![image](/assets/images/Bashed/logo.png)
...
![image](/assets/images/Bashed/ping.png)
...
![image](/assets/images/Bashed/full-ports.png)
...
![image](/assets/images/Bashed/versions-nse.png)
...
![image](/assets/images/Bashed/bash-web.png)
...
![image](/assets/images/Bashed/dir-fuzz.png)
...
![image](/assets/images/Bashed/poc-rce.png)
...
![image](/assets/images/Bashed/scriptmanager.png)
...
![image](/assets/images/Bashed/pspy.png)
...
![image](/assets/images/Bashed/root-flag.png)
